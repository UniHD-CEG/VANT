...
cfg = {
    'LeNet5': ['C6@5', 'ReLU', 'M2', 'C16@5', 'ReLU', 'M2', 'Flatten', 'FC120', 'ReLU', 'DO', 'FC84', 'ReLU', 'DO'],
...
class LeNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.features, output_channels = self._make_layers(cfg[conf_name], input_shape, dropout)
    ...
    def _make_layers(self, config, input_shape, dropout):
        layers = [
            self._noise_factory.get_noise_operator(),
        ]
